...
//  BadgeBackground
//
//  Created by Ruben Glapa on 8/14/21.
//
...
struct BadgeBackground: View {
    var body: some View {
        ...
        Path { path in
            ...
            HexagonParameters.segments.forEach { segment in
                ...
                path.addQuadCurve(to: CGPoint(x: width * segment.curve.x + xOffset, y: height * segment.curve.y), control: CGPoint(x: width * segment.control.x + xOffset, y: height * segment.control.y))
            }
        }
    ...
    static let gradientStart = Color(red: 239.0 / 255, green: 120/255, blue: 221.0 / 255)
